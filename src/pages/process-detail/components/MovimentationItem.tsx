...
export default function MovimentationItem({mov, idx, processDetailHook} : any){
            ...
            <TimelineContent>
                <Stack spacing={1}>
                    <Stack direction='row' spacing={1}>
                        ...
                        <Label
                            variant='filled'
                            color={mov.status === 'Pendente' ? 'warning' : mov.status === 'Descartado' ? 'error' : 'success'}
                        >
                            {mov.status}
                        </Label>
                        {mov.tags.map((tag: any) =>
                            <Label
