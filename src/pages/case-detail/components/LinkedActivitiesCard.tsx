...
export default function LinkedActivitiesCard({caseDetailHook, activitiesListHook} : any){
    ...
    return(
        <Card>
            ...
            <Stack spacing={3} sx={{pt: 2, pl: 3, pr:3, pb: 3}}>
                ...
                <Stack spacing={2}>
                    {process?.serviceLinkedActivities.map((act) =>
                    ...
                    <Stack direction='row'>
                        <Button
                            onClick={() => caseDetailHook.setCurrentTab(3)}
                        >
                            Ver Todas
                        </Button>
                        <Box flexGrow={1}/>
