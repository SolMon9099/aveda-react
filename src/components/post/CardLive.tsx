...
export default function CardLive({ key, post, isCommunityAdm, fromCommunity = false }: Props) {
    ...
    return <Card key={key} sx={{ borderRadius: 1, '&:hover': { cursor: 'pointer', boxShadow: 'none' } }} onClick={() => postHook.handleGoToLive()} >
        <CardContent>
            <Stack spacing={2}>
