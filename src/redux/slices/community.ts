...
export function joinCommunity(userId: string, communityId: string) {
    return async () => {
        try {
            await api.post(`/community/join`, {userId, communityId});
        } catch (error) {
            dispatch(slice.actions.hasError(error));
        }
    };
...
export function acceptCommunity(userId: string, communityId: string) {
    return async () => {
        try {
            await api.post(`/community/acceptRequest`, {userId, communityId});
        } catch (error) {
            dispatch(slice.actions.hasError(error));
        }
    };
...
export function requestCommunity(userId: string, communityId: string) {
    return async () => {
        try {
            await api.post(`/community/request`, {userId, communityId});
        } catch (error) {
            dispatch(slice.actions.hasError(error));
        }
    };
...
export function leaveCommunity(userId: string, communityId: string) {
    return async () => {
        try {
            await api.post(`/community/leave`, {userId, communityId});
        } catch (error) {
            dispatch(slice.actions.hasError(error));
        }
    };
...
export function declineRequestCommunity(userId: string, communityId: string) {
    return async () => {
        try {
            await api.post(`/community/declineRequest`, {userId, communityId});
        } catch (error) {
            dispatch(slice.actions.hasError(error));
        }
    };
...
export function getCommunityById(communityId: string,userId:any) {
    return async () => {
        ...
        try {
            var response = await api.get(`/community/details?communityId=${communityId}&userId=${userId}`)
...
export function getCommunityMembers(communityId: string) {
    return async () => {
        ...
        try {
            var response = await api.get(`/community/members?communityId=${communityId}`)
...
export function getCommunityAwaitingApproval(communityId: string) {
    return async () => {
            dispatch(slice.actions.startLoading());
        try {
            var response = await api.get(`/community/awaitingApproval?communityId=${communityId}`)
